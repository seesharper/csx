...
public static class Choco
{
    ...
    {
        Command.Execute("choco.exe", $"pack {pathToMetadata}  --outputdirectory {outputDirectory}", ".");
    }
}
...
public static class DotNet
{
    ...
    public static void Publish(string pathToProjectFile)
    {
        Command.Execute("dotnet.exe", $"publish {pathToProjectFile} -c Release -r win7-x64");        
    }
}
